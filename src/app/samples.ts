...
export const basics = {
  input: {"status":0,"step":0,"alu":{"e1":"","e2":"","op":""},"acc":1,"pc":{"val":3,"step":1},"ir":{"cmd":"","loc":""},"line":"HLT","variables":{"X":3,"Y":0,"Z":2,"W":0},"tVarCount":0,"focus":{"el":"","var":""},"code":"// X (op.Y) Z = W\n// 0 -> +\t1 -> -\n// 2 -> *\t3 -> /\nLOD Y\nJMZ 14\nSUB #1\nJMZ 19\nSUB #1\nJMZ 24\nSUB #1\nJMZ 29\nHLT\n\n// +\nLOD X\nADD Z\nJMP 33\n\n// -\nLOD X\nSUB Z\nJMP 33\n\n// *\nLOD X\nMUL Z\nJMP 33\n\n// /\nLOD X\nDIV Z\nJMP 33\n\nSTO W\nHLT"},
...
export const is_negative = {
  input: {"status":0,"step":0,"alu":{"e1":"","e2":"","op":""},"acc":1,"pc":{"val":0,"step":1},"ir":{"cmd":"","loc":""},"line":"NOP","variables":{"X":-3,"Y":0,"Z":0,"W":0,"T1":0,"T2":0},"tVarCount":0,"focus":{"el":"","var":""},"code":"// X < 0 ? Z\nLOD X\nMUL X\nSTO T1\nSUB X\nSTO T2\nJMZ 23 // 0 is positive\n\nLOD T1\nJMZ 19\nSUB #1\nSTO T1\nLOD T2\nJMZ 23\nSUB #1\nSTO T2\nJMP 7\n\n// is negative\nLOD #1\nJMP 27\n\n// is positive\nLOD #0\nJMP 27\n\n// save result\nSTO Z\nHLT"},
